...
- *Projeto de pesquisa educacional (research-driven portfolio).* <br/>

Mais informações sobre os limites do projeto estão no arquivo "limitations.md", dentro da pasta "docs".

## Objetivo do Projeto:

&emsp;  O objetivo central do projeto é mapear técnicas de Reconnaissance, trazendo à tona as principais ações que os atacantes utilizam na primeira fase da kill chain, impedindo a telemetry sources maliciosa, avaliar detection coverage, . (br/)
