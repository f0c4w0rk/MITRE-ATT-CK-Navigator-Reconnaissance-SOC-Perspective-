<!--- Objetivo do projeto --->
# Objetivo do Projeto
O objetivo deste projeto é avaliar o que é, identificar as principais funções do MITRE ATT&CK Navigator, analisar onde é usado e mapear todas as 11 técnicas de reconhecimento utilizada pelas ameaças digitais. O mapeamento das 11 técnicas de reconhecimento serão anotados na pasta "layers" e "docs" encontrados no início da página principal do projeto.

<br/>

## MITRE ATT&CK Navigator<br/>Reconnaissance (SOC Perspective)
O MITRE ATT&CK (Adversarial Tactics, Techniques & Common Knowledge) é uma base de conhecimento mantida pela organização MITRE sobre comportamentos de ataque. Esse framework é utilizado por estudantes e especialistas de cibersegurança para identificar metodologias de ameaças digitais frequentes, auxiliando na criação e melhoria de mecanismos de detecção. Ele detalha como pensa e age um Analista SOC (Blue Team) diante de ameaças, além de avaliar os processos e o pensamento do atacante antes de uma ofensiva.
